...
class CityAgent:
    ...
    def iddfs(self):
        ...
        while True:
            ...
            if result == "found":
                yield "done", path, states_explored
                return
    ...
    def best_first(self):
        ...
        while heap:
            priority, current = heapq.heappop(heap) #pop lowest heuristic
            states_explored += 1
            ...
            yield "step", current, [city for priority, city in heap]
        yield "done", None, states_explored
    ...
    def astar(self):
        ...
        while heap:
            ...
            if current in visited: #skip if already expanded
                continue
            visited.add(current)
            states_explored += 1
            ...
            yield "step", current, [city for f_score, city in heap]
        yield "done", None, states_explored
